...
def inductancia(r1,r2,mu_medio,mu_conductor,distancia_conductores,longitud_conductor): #calculara la inductancia del conductor segun el flujo magnetico y la corriente. Tambien suma la inductancia interna [H/m]
  inductancia_interna=mu_conductor/(4*np.pi)  #formula. Se considera que se esta trabajando a baja frecuencia, para que no se tenga lugar a un efecto piel considerable
...
def inductancia_aprox(r,mu_medio,distancia_conductores,longitud_conductor): #calculara la inductancia del conductor segun el flujo magnetico y la corriente. Tambien suma la inductancia interna [H/m]
  inductancia_metro_aprox=((mu_medio*np.log((distancia_conductores/r)))/(np.pi))  #formula aproximada. Inductancia por metro [H/m]
...
#-----------------------------------------------------
#Inductancia
inductancia_metro_aprox, inductancia_final_aprox=inductancia_aprox(r1,mu_medio,distancia_conductores,longitud_conductor) #esta aproximacion considera que ambos conductores tienen radio parecido a r1
...
if pregunta3=="SI":
  ...
  #Aproximaciones
  inductancia_sensibilidad_apox_metro=inductancia_aprox(radio_sensibilidad,mu_medio,distancia_conductores_sensibilidad,longitud_conductor)[0]
